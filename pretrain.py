...
class PretrainModelManager:
    ...
    def __init__(self, args, data):
        set_seed(args.seed)
        self.model = BertForModel.from_pretrained(args.bert_model, cache_dir = "", n_labels = data.n_known_cls)
        ...
        self.num_train_optimization_steps = int(math.ceil(len(data.train_labeled_examples) / args.train_batch_size)) * args.num_pretrain_epochs
    ...
    def eval(self, args, data):
        ...
        for batch in tqdm(data.eval_dataloader, desc="Iteration"):
            ...
            with torch.set_grad_enabled(False):
                _, logits = self.model(input_ids, input_mask, mode = 'eval')
    ...
    def get_optimizer(self, args):
        ...
        #                  lr = args.lr_pre, correct_bias=False)

        # num_warmup_steps = self.num_train_optimization_steps * args.warmup_proportion
        # scheduler = get_linear_schedule_with_warmup(optimizer, num_warmup_steps=num_warmup_steps, num_training_steps=self.num_train_optimization_steps)
