...
def init_model():
    ...
    parser.add_argument("--final_model_dir", default='final_models', type=str,
                        help="The output directory where the final model predictions and checkpoints will be written.")
    
    parser.add_argument("--bert_model", default="phobert", type=str, help="The path for the pre-trained bert model.")
    ...
    parser.add_argument("--known_cls_ratio", default=0.75, type=float, required=False, help="The number of known classes.")
    
    parser.add_argument("--cluster_num_factor", default=1.0, type=float, required=False, help="The factor (magnification) of the number of clusters K.")
    ...
    parser.add_argument("--num_kmean_iter", default=50, type=float,
                        help="The training epochs.")
    ...
    parser.add_argument("--num_unlabeled", default=30, required=False, type=int,
                        help="Sample for unlabeled data")

    parser.add_argument("--nredo", default=5, required=False, type=int,
                        help="num redo kmean")

    parser.add_argument("--max_points_per_centroid", default=1000000, required=False, type=int,
                        help="num max controid")
